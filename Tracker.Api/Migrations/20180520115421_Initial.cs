        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssueTracker_Department_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Department",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssueTracker_IssueType_IssueTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueTrackerId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueImage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssueImage_IssueTracker_IssueTrackerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(nullable: true),
                    IssueTrackerId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueResponse", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssueResponse_IssueTracker_IssueTrackerId",
                        column: x => x.IssueTrackerId,
                        principalTable: "IssueTracker",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueImage_IssueTrackerId",
                table: "IssueImage",
                column: "IssueTrackerId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueResponse_IssueTrackerId",
                table: "IssueResponse",
                column: "IssueTrackerId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueTracker_DepartmentId",
                table: "IssueTracker",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueTracker_IssueTypeId",
                table: "IssueTracker",
                column: "IssueTypeId");
        }
